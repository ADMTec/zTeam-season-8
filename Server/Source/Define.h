...
#define ENABLETEST_ARCA					TRUE
#define ENABLETEST_ACHERON				TRUE
...
#define ENABLE_CUSTOM_HARDCORE			FALSE
#define ENABLE_CUSTOM_PVPBALANCE		FALSE
#define ENABLE_CUSTOM_MONSTERSPAWNER	FALSE
...
#define FILE_BLUE_EVENT			        "Custom\\Event\\BlueEvent.dat"
