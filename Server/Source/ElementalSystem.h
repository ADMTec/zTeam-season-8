...
public:
	...
	//New Pentagram drop rate added

	int m_iLorenciaK_DropLevel;
	int m_iLorenciaK_DropRate;


	int m_iIronS_DropLevel;
	int m_iIronS_DropRate;

	int m_iHeroE_DropLevel;
	int m_iHeroE_DropRate;

	int m_iBraveHE_DropLevel;
	int m_iBraveHE_DropRate;

	int m_iGladiatorsD_DropLevel;
	int m_iGladiatorsD_DropRate;

	int m_iMGladiatorsD_DropLevel;
	int m_iMGladiatorsD_DropRate;

	int m_iKMadnessB_DropLevel;
	int m_iKMadnessB_DropRate;

	int m_iKMagicSS_DropLevel;
	int m_iKMagicSS_DropRate;

	int m_iEmpireGS_DropLevel;
	int m_iEmpireGS_DropRate;

	int m_iAncientIS_DropLevel;
	int m_iAncientIS_DropRate;

	int m_iArcaP_DropLevel;
	int m_iArcaP_DropRate;

	int m_iAntoniasS_DropLevel;
	int m_iAntoniasS_DropRate;

	int m_iKundunsSS_DropLevel;
	int m_iKundunsSS_DropRate;
